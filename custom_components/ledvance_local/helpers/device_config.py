"""
Config parser for Ledvance Local devices.
"""
...
import custom_components.ledvance_local.devices as config_dir
...
class TuyaDeviceConfig:
    """Representation of a device config for Ledvance Local devices."""
