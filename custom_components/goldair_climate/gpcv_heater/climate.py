"""
Goldair GPCV Heater device.

This heater differs from the GPPH range. See Issue #27

dps:
  1 = hvac_mode (boolean)
  2 = child_lock (boolean)
  3 = target temperature (integer)
  4 = current temperature (integer)
  5 = timer minutes (integer)
  6 = fault code?
  7 = preset_mode (string: High/Low)
"""
from homeassistant.const import (
    ATTR_TEMPERATURE, STATE_UNAVAILABLE
)
...
class GoldairGPCVHeater(ClimateDevice):
    """Representation of a GPCV Wi-Fi heater."""
